...
const extractName = ({ name, firstname }) =>`Je test ${name} ${firstname}` ;
console.log("extractName : ", extractName({ name: "toto",firstname: "tata", age: 42 }));
...
console.log("removePassword : ", removePassword({ name: "toto", password: "1234" }));
