...
function App() {
  ...
  const handleChangeEmpNumber = (e) => {
    setFormData({ ...formData, empNumber: e.target.value });
  };
  ...
  return (
    <div className="m-10">
      <form className="mx-auto m-5 max-w-96 p-8" onSubmit={handleSubmit}>
        <div className="mb-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChangeEmpNumber}
